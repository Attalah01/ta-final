      ...
      <div className="w-full 800px:flex items-center">
        ...
        <div className="800px:w-[50%] w-full">
          ...
          <p className={styles.label}>
            <b>"Our Students Are Our Strength"</b> emphasizes the importance of
            students in an educational institution's success. It suggests that
            the institution values its students as the driving force behind its
            achievements. "See What They Say About Us" encourages others to
            explore student testimonials, highlighting transparency and
            confidence in the institution's performance and student
            satisfaction.
          </p>
        </div>
        <br />
